...
export default function TrendingContent({ propWidth, propPadding, username, roomName }) {
    ...
    return (
        <Card style={{ background: 'inherit', width: propWidth, padding: propPadding ? propPadding : 0, border: 'none' }}>
            ...
            <Card.Body style={{ backgroundColor: `${PRIMARY_COLOR}}`, paddingLeft: '0' }}>
                <Card.Title><a href="/bla">{roomName}</a></Card.Title>
                <Card.Text className="long-and-truncated cut-on-third">
