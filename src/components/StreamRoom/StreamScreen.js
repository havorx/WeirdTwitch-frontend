...
export default function StreamScreen() {
    return (
        <Card className="comment-side d-flex justify-content-between" style={{ backgroundColor: `${SUB_PRIMARY_COLOR}` }}>
            <Card.Header style={{ backgroundColor: `${SUB_PRIMARY_COLOR}`, border: 'none' }}>
                <div className="d-flex justify-content-between ">
                    <div className="d-flex align-items-center">
                        <h2 style={{ color: SECONDARY_COLOR }} className="d-inline me-4">Room name</h2>
            ...
            <Card.Footer className="d-flex justify-content-center align-items-center" style={{ backgroundColor: '#232323', border: 'none' }}>
