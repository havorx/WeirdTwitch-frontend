...
export default function StreamScreen({roomName, isStreamer, member, topic, setTopic}) {
    ...
    function handleLeave() {
        myAxios.patch('/rooms/leave-room', {
    ...
    return (
        <Card className="comment-side d-flex justify-content-between" style={{backgroundColor: `${SUB_PRIMARY_COLOR}`}}>
            ...
            <Card.Footer className="d-flex justify-content-center align-items-center"
                ...
                {isStreamer && <Button className="audio-btn" variant="outline-none"><Mic/></Button>}
                <Button onClick={handleLeave} className="audio-btn red-btn" variant="outline-none">
                    <PhoneOff/>
                </Button>
            </Card.Footer>
        </Card>
